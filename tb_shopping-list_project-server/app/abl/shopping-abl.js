...
const Errors = require("../api/errors/shopping-error.js");
...
const logger = LoggerFactory.get("ShoppingAbl");
  ...
  async init(uri, dtoIn, session) {
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "TbShopping",
        typeCode: "tb-shopping-list-project",
        location: location,
...
module.exports = new ShoppingAbl();
