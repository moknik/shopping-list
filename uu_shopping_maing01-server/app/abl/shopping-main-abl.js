...
const Errors = require("../api/errors/shopping-main-error.js");
...
const logger = LoggerFactory.get("ShoppingMainAbl");

class ShoppingMainAbl {
  constructor() {
...
module.exports = new ShoppingMainAbl();
